...
Статус: **Phase 1 — Minimal Android skeleton**.

Проект содержит минимальную Kotlin Android-структуру с Jetpack Compose-экраном-заглушкой для Aelita-Fon v0.1. Launcher mode, локальная база данных, background services, Accessibility, Notification Listener, Shizuku, root-интеграции, локальная LLM-интеграция и AI-логика ещё не реализованы.
